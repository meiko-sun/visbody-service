...
public class DateUtils  {
	...
	public static String DATE_FORMAT_DATEONLY_HOUR = "yyyy-MM-dd hh"; // 年/月/日
	public static String DATE_FORMAT_DATEONLY = "yyyy-MM-dd"; // 年/月/日
	public static String DATE_FORMAT_DAY = "yyyy-MM";
	...
	public static final SimpleDateFormat HMS_FORMATS = new SimpleDateFormat("mmss");
	...
	/**
	 * @方法名: getDateFromISO .
	 * @描述: java 得到ISO 8601 时间格式 .
	 * @程序猿: zpp .
	 * @返回值: String .
	 * @日期: 2017年5月12日 上午10:31:32 .
	 * @throws
	 */
	...
	/**
	 * @方法名: getFetureDaysList .
	 * @描述: 获取未来 任意天内的日期数组 .
	 * @程序猿: zpp .
	 * @返回值: List<String> .
	 * @日期: 2017年5月16日 下午3:03:59 .
	 * @throws
	 */
	public static List<String> getFetureDaysList(int intervals) {
		List<String> fetureDaysList = Lists.newArrayList();
	...
	public static List<String> getFetureDaysListTwo(int intervals) {
		List<String> fetureDaysList = Lists.newArrayList();
		for (int i = 0; i < intervals; i++) {
			fetureDaysList.add(getFetureDateTwo(i));
		}
		return fetureDaysList;
	}
	/**
	...
	public static String getFetureDate(int past) {
		...
		return SHORT_DATE_FORMAT.format(today);
	}
	
	public static String getFetureDateTwo(int past) {
		Calendar calendar = Calendar.getInstance();
		calendar.set(Calendar.DAY_OF_YEAR, calendar.get(Calendar.DAY_OF_YEAR) + past - 2);
		Date today = calendar.getTime();
		return SHORT_DATE_FORMAT.format(today);
	}
	/**
	 * @throws ParseException 
	 * @方法名: getDayByDateList .
	 * @描述: 通过日期集合获取所需天集合 .
	 * @程序猿: zpp .
	 * @返回值: List<String> .
	 * @日期: 2017年5月16日 下午1:58:39 .
	 * @throws
	 */
	public static int getDayByDate(String fetureDate) throws ParseException {
		Calendar cal = Calendar.getInstance();
		Date courseDate = SHORT_DATE_FORMAT.parse(fetureDate);
	 ...
	 * @程序猿: zpp .
	 * @返回值: String .
	 * @日期: 2017年5月16日 下午2:50:05 .
	 * @throws
	 */
	public static String getWeek(String date) throws ParseException {
		String[] weeks = { "周日", "周一", "周二", "周三", "周四", "周五", "周六" };
		Calendar cal = Calendar.getInstance();
		Date courseDate = SHORT_DATE_FORMAT.parse(date);
		cal.setTime(courseDate);
		int week_index = cal.get(Calendar.DAY_OF_WEEK) - 1;
		if (week_index < 0) {
			week_index = 0;
		}
		return getDaysBetween(courseDate, paseDate(new Date())) == 0 ? "今天" : weeks[week_index];
	}
	
	public static Date paseDate(Date date){
		if(null == date)
			return null;
		String dateStr = SHORT_DATE_FORMAT.format(date);
		return StringToDate(dateStr, DATE_FORMAT_DATEONLY);
	}
     ...
     * @程序猿: zpp .
     * @返回值: long .
     * @日期: 2017年5月16日 下午2:57:29 .
     * @throws
     */
	public static long getDaysBetween(Date date0, Date date1) {
		long daysBetween = (date0.getTime() - date1.getTime()) / 3600*24*1000; // 86400000=3600*24*1000
		return daysBetween;
	}
	
	/**
	 * @方法名: getHourseByTwoDates .
	 * @描述: 判断两个日期相差几个小时 .
	 * @程序猿: zpp .
	 * @返回值: long .
	 * @日期: 2017年6月10日 下午4:18:10 .
	 * @throws
	 */
	public static long getHourseByTwoDates(Date date0, Date date1){
		long daysBetween = (date0.getTime() - date1.getTime()); 
		long nh = 60*60*1000;
		return daysBetween / nh;
	}
	
//	public static void main(String[] args) throws ParseException {
//		System.out.println(getHourseByTwoDates(DateUtils.StringToDate("2017-08-09 16:00:00", "yyyy-MM-dd HH:mm:ss"), 
//				DateUtils.getSystemDate()));
//		System.out.println(2325 / 10);
//	}
	...
	public static String getReqDateY(Date date) {
	...
	public static String getReqTime() {
		return HMS_FORMATS.format(new Date());
	}
	...
	public static boolean dateIsBetween(Date date, Date startDate, Date endDate) {
			...
			long startNumber = startDate.getTime();
			long endNumber = endDate.getTime();
			if (startNumber <= dateNumber && dateNumber <= endNumber) {
				return true;
			} else {
				return false;
			}
	...
	public static String getSysDateString(Date date) {
		return toString(date, DateUtils.sdfDateTime);
	}
	/**
	...
	/**
	 * @方法名: dateTimeToStringYMD .
	 * @描述: 转换指定日期格式 .
	 * @程序猿: zhaoPeng .
	 * @返回值: String .
	 * @日期: 2016年12月13日 下午5:46:35 .
	 * @throws
	 */
	public static String dateTimeToStringYMD(String dateStr){
		SimpleDateFormat sdf = new SimpleDateFormat(DateUtils.DATE_FORMAT_DATEONLY);
		String createTimeStr = sdf.format(dateStr);
		return createTimeStr;
	}
	 ...
	 *  转换日期字符期，年、月、日
	  ...
	  * @描述: TODO .
	  * @程序猿: chenjingwu .
	  * @日期: 2017年9月25日 下午7:53:22
	  * @返回值: String  
	  * @版本号: V2.0 .
	  * @throws
	 */
	public static String StringToStr(String dateString, String format) {
		SimpleDateFormat sdf = new SimpleDateFormat(format);
		String date = null;
		try {
	...
	/**
	 * @方法名: NextDateHourToDate .
	 * @描述: 设置下一天到期时间
	 * @程序猿: chenjingwu .
	 * @返回值: Date .
	 * @日期: 2017年3月8日 下午12:34:27 .
	 * @throws
	 */
	public static Date NextDateHourToDate(Integer day, Integer Hour, String format) {
		return DateUtils.StringToDate(DateUtils.getReqDate(DateUtils.getDate(day)) + " " + Hour, format);
	}
	 ...
	 * 
	  ...
	  * @描述: 计算年龄.
	  * @程序猿: sundefa .
	  * @日期: 2017年9月4日 上午11:19:31
	  * @返回值: Date  
	  * @版本号: V2.0 .
	  * @throws
	 */
	public static int getAgeBirthday(Date birthTime) {
		DateFormat sdf = new SimpleDateFormat(DATE_FORMAT_DATEONLY);
	    String 	birthTimeString=sdf.format(birthTime);
			// 先截取到字符串中的年、月、日  
	 ...
	 * @程序猿: chenjingwu .
	 * @返回值: String[] .
	 * @日期: 2017年4月28日 下午5:26:18 .
	 * @throws
	 */
	public static String[] nextDateToSum(Date sdate) {
		String[] dayTime = new String[DateUtils.monthDay()+1];
		SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd");// 设置日期格式
		for (int i = 0; i < DateUtils.monthDay()+1; i++) {
			dayTime[i] = df.format(DateUtils.addDay(sdate, i-2));
		}
...
////		Date date = DateUtils.StringToDate("2017-1-31 00:00:00", "yyyy-MM-dd HH:mm:ss");
//		System.out.println(DateUtils.getDateDiff("2017-1-24 13:00:00","2017-1-31 00:00:00"));
////		System.out.println(DateUtils.nextDateToSum(new Date()));
//	}
}
